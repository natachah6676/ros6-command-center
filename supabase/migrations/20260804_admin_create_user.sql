-- ROS6 — création / association des comptes R4-R5 (migration)
-- Compatible réexécution. Ne supprime aucune donnée.
-- RLS conservé. Aucune Secret Key ici.
...
-- ---------------------------------------------------------------------------
-- Garde-fous métier (non-R5 ne change pas rôle / joueur / statut)
-- ---------------------------------------------------------------------------
...
-- Les créations / associations pour un autre user_id passent par
-- l’Edge Function admin-create-user (Service Role côté serveur uniquement).
